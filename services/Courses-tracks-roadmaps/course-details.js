...
const { extractYouTubeEmbedUrl } = require("../../utils/embedUtils"); // ✅ new import
...
const getCourseHeader = async (courseId) => {
    ...
    const embedUrl =
        firstVideoRes.rows[0]?.embed_url ||
        extractYouTubeEmbedUrl(firstVideoRes.rows[0]?.video_url);
